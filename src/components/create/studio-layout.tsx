...
export function StudioLayout() {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "nerv nerv-crt nerv-flicker relative h-dvh flex flex-col bg-[var(--void)] text-[var(--steel)] overflow-hidden font-[family-name:var(--font-ibm-plex-mono)]",
...
function DragOverlay({ onDrop }: { onDrop: (files: File[]) => void }) {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="absolute inset-0 z-40 flex items-center justify-center bg-[var(--void)]/95"
    >
      <div className="text-center">
        <div className="size-20 border border-[var(--nerv-orange-dim)]/40 bg-[var(--void-panel)] flex items-center justify-center mx-auto mb-4">
          <svg
            className="w-10 h-10 text-[var(--nerv-orange)]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={1.5}
        ...
        <h3 className="text-xl text-[var(--nerv-orange)] mb-2 font-[family-name:var(--font-bebas-neue)] tracking-[0.15em] uppercase glow-orange">
          DROP IMAGES HERE
        </h3>
        <p className="text-sm text-[var(--steel-dim)] uppercase tracking-[0.08em] font-[family-name:var(--font-ibm-plex-mono)]">
