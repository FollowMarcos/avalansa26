...
export default function PrivacyPolicyPage() {
  return (
    <main className="mx-auto max-w-2xl px-6 py-16 text-foreground">
      ...
      <p className="mb-6 text-sm text-muted-foreground">Last updated: March 4, 2026</p>
      ...
      <section className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        ...
        <div>
          ...
          <p>
            ...
            <a href="mailto:contact@avalansa.com" className="text-foreground underline underline-offset-4 hover:text-muted-foreground">
